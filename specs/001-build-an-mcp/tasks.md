...
- Tests intentionally deferred unless/until stability triggers (Constitution Principle 2). Manual scripts (Phase 7) serve as primary validation; formal test tasks are marked DEFERRED with explicit activation triggers.
